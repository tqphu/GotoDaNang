(function (app) {
    app.controller('placeEditController', placeEditController);

    placeEditController.$inject = ['apiService', '$scope', 'notificationService', '$state', '$stateParams'];

    function placeEditController(apiService, $scope, notificationService, $state, $stateParams) {
        $scope.place = {
            Status: true
        };
        $scope.moreImages = [];
